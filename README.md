...
| Concept | Natural Language | Machine Language | Savings |
|---------|-----------------|------------------|---------|
| Code analysis | ~800 tokens | ~300 tokens | **62%** |
| File operations | ~400 tokens | ~150 tokens | **62%** |
| Terminal commands | ~300 tokens | ~100 tokens | **67%** |
